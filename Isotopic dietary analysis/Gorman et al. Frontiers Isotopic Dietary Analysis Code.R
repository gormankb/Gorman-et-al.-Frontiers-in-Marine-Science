...
DataSet<- read.csv("Ads.INS.DataSet.Sub3.csv")
...
DataSet2<-read.csv("Ads.INS.DataSet.Sub4.csv")
...
DataSet<- read.csv("Cks.D5.PAL.INS.DataSet.Sub2.csv")
...
DataSet<- read.csv("Cks.D15.PAL.INS.DataSet.Sub2.csv")
...
DataSet<- read.csv("Cks.5wk.PAL.INS.DataSet.Sub6.csv")
...
DataSet<- read.csv("Cks.5wk.WAP.INS.DataSet.Sub3.csv")
...
list.files()
DataSet2<- read.csv("Cks.5wk.WAP.INS.DataSet.Sub4.csv")
...
DataSet.ads.N<- read.csv("Ads.INS.DataSet.Sub3.csv")
...
DataSet.ads.C<- read.csv("Ads.INS.DataSet.Sub4.csv")
...
DataSet.cksD5.CN<- read.csv("Cks.D5.PAL.INS.DataSet.Sub2.csv")
...
DataSet.cksD15.CN<- read.csv("Cks.D15.PAL.INS.DataSet.Sub2.csv")
...
DataSet.cks5wk.PAL.CN<- read.csv("Cks.5wk.PAL.INS.DataSet.Sub6.csv")
...
DataSet.cks5wk.WAP.N<- read.csv("Cks.5wk.WAP.INS.DataSet.Sub3.csv")
...
DataSet.cks5wk.WAP.C<- read.csv("Cks.5wk.WAP.INS.DataSet.Sub4.csv")
